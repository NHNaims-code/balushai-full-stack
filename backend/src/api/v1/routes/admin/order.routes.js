...
function orderRoutes(app) {
    ...
    app.get('/XYZ!@!/admin/sla-beached-orders',adminAuthentication, tryCatchHandle(orderController().getSLABeachedOrders));
    ...
    app.get('/XYZ!@!/admin/sla-beached-order-counts',adminAuthentication, tryCatchHandle(orderController().getSLABeachedOrderCounts));
}
export { orderRoutes };