...
function wishlistRoutes(app) {
    ...
    app.post('/customer/create-wishlist', customerAuthentication, tryCatchHandle(wishlistController().addToWishlist));
    ...
    app.delete('/customer/delete-wishlist-item/', customerAuthentication, tryCatchHandle(wishlistController().deleteWishlistItem));
