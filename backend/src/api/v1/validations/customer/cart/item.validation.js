import Joi from "joi"
const itemValidation = ({ product_id, color_family, price, special_price, offer_price, image_url, size, quantity }) => {
    ...
    const { value, error } = joiSchema.validate({ product_id, color_family, price, special_price, offer_price, image_url, size, quantity }, { escapeHtml: true })
    return { value, error }
}
