...
export default function ProductFactory(props) {
    ...
    const getAllProducts = async () => {
        TryCatch(async () => {
            const response = id ? await getProducts(props.type, 'vendor', id) : await getProducts(props.type, 'admin');
            let temp = [];
                    ...
                    <Table stickyHeader aria-label="collapsible table" size="small">
                        ...
                        <TableBody>
                            {filterProducts && products
                                ...
                                .map((product, index) => {
                                    return <ProductRow key={index} type={props.type} product={product} getAllProducts={getAllProducts} />
                                })}
                        </TableBody>
                    </Table>
                </TableContainer>
