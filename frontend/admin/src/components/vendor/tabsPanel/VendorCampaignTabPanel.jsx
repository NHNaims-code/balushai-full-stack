...
export default function VendorCampaignTabs() {
    ...
    const [SLABeachedOrdersCount, setSLABeachedOrdersCount] = useState(0);
    ...
    const getSLABeachedOrdersCount = () => {
        TryCatch(async () => {
            const cnt = await getOrderCount('SLABeached');
            setSLABeachedOrdersCount(cnt?.data || 0);
        });
    }
        ...
        <Box sx={{ width: "100%" }}>
            <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
                ...
                >
                    ...
                    <Tab sx={{ textTransform: 'capitalize', fontSize: '12px' }} label={`SLA Beached (${SLABeachedOrdersCount})`} {...a11yProps(8)} />
                </Tabs>
            </Box>
            {
