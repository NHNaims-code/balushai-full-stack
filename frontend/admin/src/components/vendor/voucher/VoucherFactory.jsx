...
export default function VendorVoucherFactory(props) {
    ...
    const getAllVouchers = () => {
        TryCatch(async () => {
            if (props?.type === 'all') {
                const res = await getVouchers(`promotions/vendor-all-vouchers/${id}`);
                setVouchers(res?.data)
            } else if (props?.type === 'active') {
                const res = await getVouchers(`promotions/vendor-active-vouchers/${id}`);
                setVouchers(res?.data)
            } else if (props?.type === 'deactive') {
                const res = await getVouchers(`promotions/vendor-deactive-vouchers/${id}`);
                setVouchers(res?.data)
            } else {
                setVouchers([])
            }
            props?.getAllVoucherCountManage()
        });
    }
    useEffect(() => {
        getAllVouchers();
