              ...
              {({ values, setFieldValue }) => (
                <Form>
                  ...
                  >
                    ...
                    />
                    <FormikSelect id="parent_id" name="parent_id" label="Parent Category" options={categories} value={values.parent_id} />
                    <FormikRichText
                      id="description"
                      name="description"
                      label="Description"
                    ...
                    />
                    <img height="50px" width="50px" className="img-fluid ml-5 my-2" src={category?.image ? category?.image?.url : ''} alt="Profile" />
                    <FormikInput
                      id="commission_rate"
