            ...
            <Formik
              ...
              initialValues={{
                ...
                limit_voucher_usage_for_customer:
                  voucher?.limit_voucher_usage_for_customer || undefined,
              }}
            >
              {({ values, setFieldValue }) => (
                <Form>
                  ...
                  >
                    ...
                    />
                    <FormikInput
                      id="limit_voucher_usage_for_customer"
                      name="limit_voucher_usage_for_customer"
                      label="Limit for Customer"
                      fixed={values?.limit_voucher_usage_for_customer}
                      type="number"
                    />
                  </Box>
