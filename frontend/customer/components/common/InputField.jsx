  ...
  return (
    <div className='grid grid-cols-6 my-3 sm:my-2'>
      ...
      <div className='col-span-6 sm:col-span-5'>
        <input id={name} name={name} onChange={onChange} defaultValue={value} placeholder={placeholder} required={required} className='border w-full p-2 outline-[#D23E41]' type={type}/>
      </div>
    </div>
  )
}
