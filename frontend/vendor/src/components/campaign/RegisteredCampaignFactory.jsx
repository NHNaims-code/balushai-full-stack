...
export default function RegisteredCampaignFactory({ type }) {
    ...
    const getAllCampaigns = () => {
        TryCatch(async () => {
            if (type === 'online') {
                const res = await getCampaigns('promotions/online-registered-campaigns');
                setCampaigns(res?.data)
            } else if (type === 'incoming') {
                const res = await getCampaigns('promotions/incoming-registered-campaigns');
                setCampaigns(res?.data)
            } else {
                setCampaigns([])
            }
