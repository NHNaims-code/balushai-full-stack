...
export default function AddVoucher() {
    ...
    const initialValues = {
        ...
        limit_voucher_usage_for_customer: undefined
    }
                ...
                >
                    {({ values, setFieldValue }) => (
                        <Form>
                            ...
                            >
                                <FormikInput id='name' name='name' label='Voucher Name' />
                                ...
                                <FormikInput id='code' name='code' label='Voucher Code' placeholder='Use letters and numbers. e.g. BALUSHAI123' />
                                ...
                                <FormikInput id='limit_voucher_usage_for_customer' name='limit_voucher_usage_for_customer' label='Limit for Customer' type="number" />
                            </Box>
